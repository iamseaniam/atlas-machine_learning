...
class Yolo:
    ...
    def load_images(folder_path):
        """
        Load images from a folder and return them as a list of numpy arrays,
        along with their corresponding file paths.
        """
        images = []
        image_paths = []
    ...
    def preprocess_images(self, images):
        """
        Preprocess a list of images by resizing and rescaling them.
        """
